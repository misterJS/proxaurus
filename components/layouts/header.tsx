    ...
    return (
        <header className={`z-40 ${themeConfig.semidark && themeConfig.menu === 'horizontal' ? 'dark' : ''}`}>
            <div className="shadow-sm">
                <div className="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-black">
                    ...
                    <div className="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                        <Link href="/" className="main-logo flex shrink-0 items-center">
                            ...
                            <span className="hidden align-middle text-2xl  font-semibold  transition-all duration-300 ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light md:inline">PROXAURUS</span>
                        </Link>
                        <button
                            type="button"
                    ...
                    {/* (DIHAPUS) Quick links: Calendar / To-Do / Chat */}

                    {/* Search + theme + language + inbox + notifications + profile */}
                                ...
                                <ul className="w-[230px] !py-0 font-semibold text-dark dark:text-white-dark dark:text-white-light/90">
                                    ...
                                    <li className="border-t border-white-light dark:border-white-light/10">
                                        <button
                                            ...
                                            className="flex w-full items-center gap-2 !py-3 px-4 text-left text-danger transition hover:bg-transparent disabled:cursor-not-allowed disabled:opacity-60"
                                        >
                ...
                {/* horizontal menu (tetap, tidak diubah) */}
                {/* ... (bagian horizontal menu kamu tetap sama persis) ... */}
            </div>
        </header>
    );
};
